...
class UserRemoteDataSourceImpl(
    ...
    override suspend fun getUser(email: String, password: String): Response<User> = tfmService.getUserInfo(email,password)

    override suspend fun rememberPassword(email: String) = tfmService.requestPasswordRecovery(email)
