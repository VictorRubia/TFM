package com.victorrubia.tfm.data.api
...
class TFMServiceTest {

    private lateinit var service: TFMService
    ...
    fun newActivity_sentRequest_receivedExpected(){
        runBlocking {
            ...
            Truth.assertThat(request.path).isEqualTo("/activities/?activity%5Bactivities_repository_id%5D=0&activity%5Bstart_d%5D=2022-05-06%2013%3A59%3A50")
        }
    }
