...
class TagsRepositoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tags_repository" do
    assert_difference("TagsRepository.count") do
      post tags_repositories_url, params: { tags_repository: { image_data: @tags_repository.image_data, name: @tags_repository.name, name_wearos: @tags_repository.name_wearos } }
    end
  ...
  test "should update tags_repository" do
    patch tags_repository_url(@tags_repository), params: { tags_repository: { image_data: @tags_repository.image_data, name: @tags_repository.name, name_wearos: @tags_repository.name_wearos } }
